...
@Autonomous(name="Blue_Tower",group="Comp")
@Disabled
public class Blue_Tower extends BaseAuto {
    ...
    public void runOpMode(){
        initSystems();
        PositionVar start = new PositionVar(-4390,30,-Pi/2);
        ...
        PositionVar shootingPos = new PositionVar(-3301,1640,0);
        PositionVar shootingPosition = new PositionVar(shootingPos.getX(),shootingPos.getY(),odom.pointedAtFrom(shootingPos,targets.BlueTower));
        
        PositionVar targetPosition1;
        PositionVar targetPosition2;
        Movement wobble2Grab;
        PositionVar wobble2GrabP;
        PositionVar end = new PositionVar(-3000,2200,0); //2200 old
        odom.setPos(start);
        // odom.disable();
        ...
        switch(fieldPos){//set setup specific positions
            ...
            case "Quad":
                ...
                break;
            default :
                targetPosition1 = new PositionVar(-4100,2450,2.653);
        }
        ...
        while(opModeIsActive()){
            ...
            if(lastPos==shootingPosition){
                ...
                launcher.setTargetVelocity(recommendedRPM+10);
                int shotCount = 0;
                boolean shooting = false;
                    while (shootTimer.milliseconds() < 15000  &&!isStopRequested()&&opModeIsActive()){//&& shotCount<3
                        launcher.update();
                        conveyor.update();
...
*/                          
                        ...
                        // if(shootTimer.milliseconds()>10000){
                        //     conveyor.setInput(.5);
                        // }
